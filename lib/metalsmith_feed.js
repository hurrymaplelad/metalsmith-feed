...
module.exports = function(options) {
  var RSS, collectionName, destination, extend, limit, postCustomElements, postDescription, ref, url;
  if (options == null) {
    options = {};
  }
  RSS = require('rss');
  ...
  url = require('url');
  limit = (ref = options.limit) != null ? ref : 20;
  ...
  return function(files, metalsmith, done) {
    var collection, feed, feedOptions, file, i, itemData, len, metadata, ref1, siteUrl;
    ...
    feedOptions = extend({}, metadata.site, options, {
      site_url: (ref1 = metadata.site) != null ? ref1.url : void 0,
